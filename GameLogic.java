...
public class GameLogic {
    ...
    public void run(Board board, Hero hero, MonsterArmy monsterArmy) {
        ...
        while (isHeroAlive && isFinalBossAlive) {
            ...
            if (this.currentLevel == board.getNumberOfLevels() - 1 && this.currentField == board.getNumberOfFields() - 1
                    && isHeroAlive) {
            ...
            if (isHeroAlive && isFinalBossAlive) {
                levels[this.currentLevel].printLevel(this.currentLevel + 1, hero.getPosition(),
                        this.isFieldTypeVisible);
            }
        }
